...
const multiplesService_1 = require("./multiplesService");
describe('Unit test for mulitples Service', () => {
    it("For numbers multiple of 3 == 'Type 1'", () => {
        ...
        for (let i = 0; i < multiplesOf3.length; i++) {
            ...
            expect(multiplesService_1.multiplesService.getNumbersType(number)).toEqual('Type 1');
        }
    });
    it("For numbers multiple of 5 == 'Type 2'", () => {
        ...
        for (let i = 0; i < multiplesOf5.length; i++) {
            ...
            expect(multiplesService_1.multiplesService.getNumbersType(number)).toEqual('Type 2');
        }
    });
    it("For numbers multiple of 3 and 5 == 'Type 3'", () => {
        ...
        for (let i = 0; i < multiplesOf3And5.length; i++) {
            ...
            expect(multiplesService_1.multiplesService.getNumbersType(number)).toEqual('Type 3');
        }
    });
    it("For numbers not multiple of 3 or 5 == number", () => {
        ...
        for (let i = 0; i < multiplesOf3And5.length; i++) {
            const number = multiplesOf3And5[i];
            expect(multiplesService_1.multiplesService.getNumbersType(number)).toEqual(number.toString());
        }
    });
    it("Correctly identify a mix of numbers", () => {
        ...
        for (let i = 0; i < multiplesOf3And5.length; i++) {
            const number = multiplesOf3And5[i];
            results.push(multiplesService_1.multiplesService.getNumbersType(number));
        }
